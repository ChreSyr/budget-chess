...
class _$LiveGameModelImpl extends _LiveGameModel {
  ...
  @override
  String toString() {
    return 'LiveGameModel(id: $id, challenge: $challenge, blackId: $blackId, whiteId: $whiteId, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, challenge, blackId, whiteId, status);
...
abstract class _LiveGameModel extends LiveGameModel {
  const factory _LiveGameModel(
      ...
      required final GameStatus status}) = _$LiveGameModelImpl;
